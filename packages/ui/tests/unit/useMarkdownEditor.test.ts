...
import { useMarkdownEditor, validateFilePath, validateFile, LoadingState } from '../../src/composables/useMarkdownEditor';
...
describe('useMarkdownEditor', () => {
  ...
  test('loads file content correctly', async () => {
    ...
    const { services } = await import('../../src/composables/useServices');
