...
export const usePreferenceStore = defineStore('preferences', () => {
  ...
  const editorPreferences = computed(() => ({
    fontSize: preferences.value.editorFontSize,
    wordWrap: preferences.value.editorWordWrap,
    showLineNumbers: preferences.value.showLineNumbers,
    ...
    enableVim: preferences.value.enableVim,
    enableEmmet: preferences.value.enableEmmet
  }))
